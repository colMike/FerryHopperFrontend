...
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor } from 'app/modules/admin/apps/users/inventory/inventory.types';
import { InventoryService } from 'app/modules/admin/apps/users/inventory/inventory.service';
...
export class InventoryListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    addTagToProduct(tag: InventoryTag): void
    {
        ...
        this.selectedCustomerForm.get('tags').patchValue(this.selectedProduct.tags);
